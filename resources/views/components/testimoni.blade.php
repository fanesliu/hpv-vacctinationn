            ...
            <div class="col-md-6 mb-4">
                <div
                    ...
                    <div class="client-info">
                        <div style="font-weight: 600; margin-bottom: 5px;">Prof. Aslab. Ali Hadi Musawa
                        </div>
            ...
            <div class="col-md-6 mb-4">
                <div
                    ...
                    <img src="{{ asset('assets/testimoni2.jpeg') }}" alt="Client"
                        style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover; margin-bottom: 20px;">
                    <p style="font-size: 0.95rem; line-height: 1.6; margin-bottom: 20px;">Steven Alexander Musthafa
                    </p>
                    <div class="client-info">
